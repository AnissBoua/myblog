	...
	<nav class="red darken-4">
		<div class="container">
			<div class="nav-wrapper">
				...
				<a href="<?=ROOT_URL?>blog_index.html" class="brand-logo">Anis Blog</a>
				...
				<ul class="right hide-on-med-and-down">
					...
					<?php if (!empty($_SESSION['is_admin']) || !empty($_SESSION['is_user'])): ?>
					<li><a href="<?=ROOT_URL?>?p=blog&amp;a=logout" class="btn red darken-1
 waves-effect waves-light">Déconnexion<i class="material-icons right">lock_outline</i></a></li>
					<?php endif ?>
				</ul>
